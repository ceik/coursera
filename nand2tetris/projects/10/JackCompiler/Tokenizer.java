...
public class Tokenizer {
        ...
        try {
            ...
            while ((sourceLine = inputStream.readLine()) != null) {
                ...
                if (cleanLine.isEmpty()) {
                    continue;
                // Need to handle lines with only "}" separately so that the
    ...
    static void writeToken(TokenStorage tokens, String token,
            String lexElem) {
        // Throw away spaces
        ...
        if (!cleanToken.isEmpty()) {
            ...
            tokens.map.put(lineCounter, new String[]{lexElem, cleanToken});
            lineCounter += 1;
        }
    }
